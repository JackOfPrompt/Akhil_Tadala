...
Supabase 🧠 (Database 🗄️, Edge Functions ⚙️, Auth 🔐, Third-party integrations 🔌)
SaaS systems that favor reliability 🪨 over buzzwords ✂️

🎯 How I Work
Clear ownership, fewer meetings
Practical engineering over theory
Shipping > slide decks
GitHub is where I document real builds 🧩, experiments 🧪, and production-ready patterns 🧱 — not demo-ware.
